...
<body class="hm">
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Update PRESCRIPTION</h3>
							<%
								} else {
							%>
							<h3 class="text-center default-text text-primary">Add PRESCRIPTION</h3>
							<%
								}
							%>
							<!--Body-->
	...
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("name", request)%></font></br>
	 ...
	 <span class="pl-sm-5"><b>Capacity</b>
	<span style="color: red;">*</span></span> </br>
    <div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" class="form-control" name="capacity" placeholder="capacity" value="<%=DataUtility.getStringData(dto.getCapacity())%>">
      </div>
    </div>
	...
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("dob", request)%></font></br>
					<%
							...
							<div class="text-center">
								...
								<input type="submit" name="operation" class="btn btn-success btn-md" style="font-size: 17px" value="<%=PrescriptionCtl.OP_UPDATE%>"> 
									
									<input type="submit" name="operation" class="btn btn-warning btn-md" style="font-size: 17px" value="<%=PrescriptionCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation" class="btn btn-success btn-md" style="font-size: 17px" value="<%=PrescriptionCtl.OP_SAVE%>"> 
								
								<input type="submit" name="operation" class="btn btn-warning btn-md" style="font-size: 17px" value="<%=PrescriptionCtl.OP_RESET%>">
							</div>
