...
public final class ModelFactory {
	 ...
	 * 
	 * PrescriptionModelInt PrescriptionModel = (PrescriptionModelInt) modelCache.get("PrescriptionModel"); if
	 * (PrescriptionModel == null) { if ("Hibernate".equals(DATABASE)) { PrescriptionModel = new
	 * PrescriptionModelHibImp(); }
	 * 
	 * if ("JDBC".equals(DATABASE)) { PrescriptionModel = new UserModelJDBCImpl(); }
	 * 
